...
namespace AtrocidadesRSS.Generator.Web.Models.Cases;
...
public class CaseFormModel
{
    ...
    /// </summary>
    public AtrocidadesRSS.Generator.Contracts.Cases.CreateCaseRequest ToCreateRequest()
    {
        return new AtrocidadesRSS.Generator.Contracts.Cases.CreateCaseRequest
        {
            CrimeDate = CrimeDate,
    ...
    /// </summary>
    public AtrocidadesRSS.Generator.Contracts.Cases.UpdateCaseRequest ToUpdateRequest()
    {
        return new AtrocidadesRSS.Generator.Contracts.Cases.UpdateCaseRequest
        {
            CrimeDate = CrimeDate,
            ReportDate = ReportDate,
            VictimName = VictimName,
    ...
    /// </summary>
    public static CaseFormModel FromCase(AtrocidadesRSS.Generator.Infrastructure.Persistence.Entities.Case caseEntity)
    {
