...
namespace OpenJustice.Generator;

/// <summary>
/// Extension methods for configuring OpenJustice services
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Add OpenJustice configuration to the service collection
    /// </summary>
    public static IServiceCollection AddOpenJusticeConfiguration(
    ...
    /// <summary>
    /// Validate configuration at startup - call after AddOpenJusticeConfiguration
    /// </summary>
    public static IServiceCollection ValidateOpenJusticeConfiguration(this IServiceCollection services)
    {
