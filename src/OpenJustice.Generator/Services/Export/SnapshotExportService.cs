...
namespace OpenJustice.Generator.Services.Export;
...
public class SnapshotExportOptions
{
    ...
    /// </summary>
    public string Database { get; set; } = "openjustice";
...
public class SnapshotExportService : ISnapshotExportService
{
    ...
    {
        return ExtractConnectionPart(connectionString, "dbname") ?? "openjustice";
    }
