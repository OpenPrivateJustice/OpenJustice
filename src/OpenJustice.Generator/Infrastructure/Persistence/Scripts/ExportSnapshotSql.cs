...
namespace OpenJustice.Generator.Infrastructure.Persistence.Scripts;
...
public class ExportSnapshotSql
{
    public static async Task Main(string[] args)
    {
        ...
        var version = "v1";
        var outputPath = args.Length > 0 ? args[0] : $"openjustice_{version}_{timestamp}.sql";
        ...
        // Write header
        await writer.WriteLineAsync($"-- OpenJustice Database Snapshot");
        ...
        await writer.WriteLineAsync("-- Run with: psql -d openjustice -f <filename>.sql");
        await writer.WriteLineAsync();
    ...
    private static string FindMigrationsDirectory()
    {
        ...
        var possiblePaths = new[]
        {
            ...
            Path.Combine(Directory.GetCurrentDirectory(), "src", "OpenJustice.Generator", "Infrastructure", "Persistence", "Migrations"),
            Path.Combine(Directory.GetCurrentDirectory(), "Infrastructure", "Persistence", "Migrations"),
            "./src/OpenJustice.Generator/Infrastructure/Persistence/Migrations"
        };
        ...
        {
            var migrationsPath = Path.Combine(currentDir, "src", "OpenJustice.Generator", "Infrastructure", "Persistence", "Migrations");
