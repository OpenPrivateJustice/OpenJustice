...
namespace OpenJustice.Generator.Tests.Export;
...
public class SnapshotExportServiceTests
{
    ...
    public SnapshotExportServiceTests()
    {
        ...
        _options = new SnapshotExportOptions
        {
            ...
            ConnectionString = "Host=localhost;Database=openjustice;Username=postgres;Password=test",
            FilePrefix = "snapshot"
        };
    }
    ...
    {
        // Arrange
        _options.ConnectionString = "Host=localhost;Database=openjustice;Username=postgres;Password=test";
